...
void matrix_class::matrix_normalization_pseudoc(
  ...
  // cout << "Matrix after normalization_pseudoc: " << endl;
  // for (unsigned short int i = 0; i < norm_matrix.size(); i++) {
  //   for (unsigned short int j = 0; j < norm_matrix[i].size(); j++) {
...
void matrix_class::matrix_normalization(
  ...
  // cout << "Matrix after second normalization: " << endl;
  // for (unsigned short int i = 0; i < norm_matrix.size(); i++) {
  //   for (unsigned short int j = 0; j < norm_matrix[i].size(); j++) {
  //     cout << norm_matrix[i][j] << "\t";
  //   }
...
void matrix_class::matrix_logarithmic(
  ...
  // cout << "Matrix logarithmic: " << endl;
  // for (unsigned short int i = 0; i < matrix_log.size(); i++) {
  //   for (unsigned short int j = 0; j < matrix_log[i].size(); j++) {
  //     cout << matrix_log[i][j] << "\t";
  //   }
  //   cout << endl;
  // }
...
void oligo_class::find_minmax(vector<vector<double>> &matrix) {
  ...
  // cout << "Min possible score: " << min_possible_score << endl;
  // cout << "Max possible score: " << max_possible_score << endl;
}
...
void HammingClass::CheckSeed(string seed,
  ...
  for (multimap<int, string>::iterator it = pos.begin(); it != pos.end();
    ...
    if (count <= distance_vector[d]) {
      ...
      cout << "Hamming_v_occ " << hamming_v_occ << endl;
...
void z_test_class::oligos_vector_creation_PWM(vector<bed_class> &GEP) {
  ...
  cout << all_global_scores.size() << "\t" << all_local_scores.size() << endl;
}
